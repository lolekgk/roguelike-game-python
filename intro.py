...
END_MESSAGE_LOSE = ["Sorry mate, this time you didn't make it.",
                    "The summer vacation starts tomorrow,",
                    "the Dean's office will be closed for 3 months",
                    "and you don't even have your Grade Transcript",
                    "to show your family that you have not wasted ",
...
END_MESSAGE_WIN = ["GRADE TRANSCRIPT",
                    "",
                    # f"Student {name}",
                    "You have succesfully passed the following exams:",
                    "",
                    "1. Mathematics",
